...
import ru.yandex.rest.ServerApp;
...
public class ClientAppTest {
    ...
    public void setUp() throws Exception {
        ...
        tree = new ExpressionNodeDeserializer().deserialize(testing);
    }
    ...
    public void testGetTree() throws IOException {
        ...
        ExpressionNode expressionNode = new ExpressionNodeDeserializer().deserialize(jsonInString);
